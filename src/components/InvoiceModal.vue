<template>
  <div @click="checkClick" ref="invoiceWrap" class="invoice-wrap flex flex-column">
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <h1 v-if="!editInvoice">Nouvelle facture</h1>
      ...
      <div class="bill-from flex flex-column">
        ...
        <div class="input flex flex-column">
          <label for="billerStreetAddress">Adresse de la rue</label>
        ...
        <div class="location-details flex">
          ...
          <div class="input flex flex-column">
            <label for="billerZipCode">Code postal</label>
      ...
      <div class="bill-to flex flex-column">
        ...
        <div class="input flex flex-column">
          <label for="clientEmail">Courriel du client</label>
          <input required type="text" id="clientEmail" v-model="clientEmail"/>
        </div>
        <div class="input flex flex-column">
          <label for="clientStreetAddress">Adresse de la rue</label>
        ...
        <div class="location-details flex">
          ...
          <div class="input flex flex-column">
            <label for="clientZipCode">Code postal</label>
      ...
      <div class="invoice-work flex flex-column">
        <div class="payment flex">
          ...
          <div class="input flex flex-column">
            <label for="paymentDueDate">Paiement dû</label>
        ...
        <div class="work-items">
          ...
          <table class="item-list">
            <tr class="table-heading flex">
              <th class="item-name">Nom de l'article</th>
              <th class="qty">Qté</th>
      ...
      <div class="save flex">
        ...
        <div class="right flex">
          <button v-if="!editInvoice" type="submit" @click="saveDraft" class="dark-purple">Sauvegarder le projet</button>
          <button v-if="!editInvoice" type="submit" @click="publishInvoice" class="purple">Créer une facture</button>
          <button v-if="editInvoice" type="sumbit" class="purple">Mise à jour de la facture</button>
        </div>
      </div>
    </form>
  </div>
